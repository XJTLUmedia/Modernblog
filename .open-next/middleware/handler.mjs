...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), e.s(["config", 0, { matcher: ["/admin/:path*", "/auth/:path*", "/api/auth/:path*"] }, "middleware", 0, function(e10) {
        let { pathname: t10 } = e10.nextUrl;
        if (t10.startsWith("/auth")) return es.next();
        if (t10.startsWith("/admin")) {
          let t11 = e10.cookies.get("user_id")?.value, r2 = e10.cookies.get("user_role")?.value, n2 = e10.cookies.get("is_admin")?.value === "true";
          if (!t11) return es.redirect(new URL("/auth/login", e10.url));
          if ("admin" !== r2 && !n2) return es.redirect(new URL("/", e10.url));
        }
        return es.next();
      }], 99446);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [], "qualities": [75], "unoptimized": false, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": false, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "A:\\Study2\\Programming\\python-project-consolidated\\personal_blog", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": false, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "partialFallbacks": false, "dynamicOnHover": false, "varyParams": false, "prefetchInlining": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 15, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "serverExternalPackages": ["@prisma/client", ".prisma/client", "googleapis", "@modelcontextprotocol/sdk", "openai", "bcryptjs", "replicate", "cheerio"], "turbopack": { "root": "A:\\Study2\\Programming\\python-project-consolidated\\personal_blog" }, "distDirRoot": ".next", "_originalRedirects": [{ "source": "/projects", "destination": "/forge", "permanent": true }, { "source": "/projects/:slug", "destination": "/forge/:slug", "permanent": true }] };
var BuildId = "KPt2C626p4VEDV0-kLZ21";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }, { "source": "/projects", "destination": "/forge", "statusCode": 308, "regex": "^(?!/_next)/projects(?:/)?$" }, { "source": "/projects/:slug", "destination": "/forge/:slug", "statusCode": 308, "regex": "^(?!/_next)/projects(?:/([^/]+?))(?:/)?$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin/dashboard", "regex": "^/admin/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/dashboard(?:/)?$" }, { "page": "/admin/garden", "regex": "^/admin/garden(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/garden(?:/)?$" }, { "page": "/admin/garden/new", "regex": "^/admin/garden/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/garden/new(?:/)?$" }, { "page": "/admin/hub", "regex": "^/admin/hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/hub(?:/)?$" }, { "page": "/admin/posts", "regex": "^/admin/posts(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/posts(?:/)?$" }, { "page": "/admin/posts/new", "regex": "^/admin/posts/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/posts/new(?:/)?$" }, { "page": "/admin/projects", "regex": "^/admin/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/projects(?:/)?$" }, { "page": "/admin/projects/new", "regex": "^/admin/projects/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/projects/new(?:/)?$" }, { "page": "/admin/settings", "regex": "^/admin/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/settings(?:/)?$" }, { "page": "/api", "regex": "^/api(?:/)?$", "routeKeys": {}, "namedRegex": "^/api(?:/)?$" }, { "page": "/api/admin/garden", "regex": "^/api/admin/garden(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/garden(?:/)?$" }, { "page": "/api/admin/hub", "regex": "^/api/admin/hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/hub(?:/)?$" }, { "page": "/api/admin/posts", "regex": "^/api/admin/posts(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/posts(?:/)?$" }, { "page": "/api/admin/projects", "regex": "^/api/admin/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/projects(?:/)?$" }, { "page": "/api/admin/settings", "regex": "^/api/admin/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/settings(?:/)?$" }, { "page": "/api/ai/chunk", "regex": "^/api/ai/chunk(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/chunk(?:/)?$" }, { "page": "/api/ai/image", "regex": "^/api/ai/image(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/image(?:/)?$" }, { "page": "/api/ai/mnemonic", "regex": "^/api/ai/mnemonic(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/mnemonic(?:/)?$" }, { "page": "/api/ai/recall-questions", "regex": "^/api/ai/recall\\-questions(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/recall\\-questions(?:/)?$" }, { "page": "/api/ai/search", "regex": "^/api/ai/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/search(?:/)?$" }, { "page": "/api/ai/text", "regex": "^/api/ai/text(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/text(?:/)?$" }, { "page": "/api/ai/verify", "regex": "^/api/ai/verify(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/verify(?:/)?$" }, { "page": "/api/ai/video", "regex": "^/api/ai/video(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/video(?:/)?$" }, { "page": "/api/ai/web-read", "regex": "^/api/ai/web\\-read(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ai/web\\-read(?:/)?$" }, { "page": "/api/auth/check", "regex": "^/api/auth/check(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/check(?:/)?$" }, { "page": "/api/auth/forgot-password", "regex": "^/api/auth/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/forgot\\-password(?:/)?$" }, { "page": "/api/auth/google", "regex": "^/api/auth/google(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/google(?:/)?$" }, { "page": "/api/auth/google/callback", "regex": "^/api/auth/google/callback(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/google/callback(?:/)?$" }, { "page": "/api/auth/login", "regex": "^/api/auth/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/login(?:/)?$" }, { "page": "/api/auth/logout", "regex": "^/api/auth/logout(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/logout(?:/)?$" }, { "page": "/api/auth/register", "regex": "^/api/auth/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/register(?:/)?$" }, { "page": "/api/auth/reset-password", "regex": "^/api/auth/reset\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/reset\\-password(?:/)?$" }, { "page": "/api/comments", "regex": "^/api/comments(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comments(?:/)?$" }, { "page": "/api/garden", "regex": "^/api/garden(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/garden(?:/)?$" }, { "page": "/api/guestbook", "regex": "^/api/guestbook(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/guestbook(?:/)?$" }, { "page": "/api/hub", "regex": "^/api/hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/hub(?:/)?$" }, { "page": "/api/posts", "regex": "^/api/posts(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/posts(?:/)?$" }, { "page": "/api/projects", "regex": "^/api/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/projects(?:/)?$" }, { "page": "/api/reactions", "regex": "^/api/reactions(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/reactions(?:/)?$" }, { "page": "/api/search", "regex": "^/api/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/search(?:/)?$" }, { "page": "/api/subscriptions", "regex": "^/api/subscriptions(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/subscriptions(?:/)?$" }, { "page": "/api/summarize", "regex": "^/api/summarize(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/summarize(?:/)?$" }, { "page": "/api/system/stats", "regex": "^/api/system/stats(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/system/stats(?:/)?$" }, { "page": "/api/system/status", "regex": "^/api/system/status(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/system/status(?:/)?$" }, { "page": "/api/upload", "regex": "^/api/upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/upload(?:/)?$" }, { "page": "/api/user/activity", "regex": "^/api/user/activity(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/activity(?:/)?$" }, { "page": "/api/user/ai-history", "regex": "^/api/user/ai\\-history(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/ai\\-history(?:/)?$" }, { "page": "/api/user/badges", "regex": "^/api/user/badges(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/badges(?:/)?$" }, { "page": "/api/user/bookmark", "regex": "^/api/user/bookmark(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/bookmark(?:/)?$" }, { "page": "/api/user/profile", "regex": "^/api/user/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/profile(?:/)?$" }, { "page": "/api/user/security/password", "regex": "^/api/user/security/password(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/security/password(?:/)?$" }, { "page": "/api/user/settings/notifications", "regex": "^/api/user/settings/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/settings/notifications(?:/)?$" }, { "page": "/api/user/settings/privacy", "regex": "^/api/user/settings/privacy(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/settings/privacy(?:/)?$" }, { "page": "/api/user/stats", "regex": "^/api/user/stats(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/stats(?:/)?$" }, { "page": "/auth/forgot-password", "regex": "^/auth/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/forgot\\-password(?:/)?$" }, { "page": "/auth/login", "regex": "^/auth/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/login(?:/)?$" }, { "page": "/auth/signup", "regex": "^/auth/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/signup(?:/)?$" }, { "page": "/blog", "regex": "^/blog(?:/)?$", "routeKeys": {}, "namedRegex": "^/blog(?:/)?$" }, { "page": "/forge", "regex": "^/forge(?:/)?$", "routeKeys": {}, "namedRegex": "^/forge(?:/)?$" }, { "page": "/garden", "regex": "^/garden(?:/)?$", "routeKeys": {}, "namedRegex": "^/garden(?:/)?$" }, { "page": "/hub", "regex": "^/hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/hub(?:/)?$" }, { "page": "/now", "regex": "^/now(?:/)?$", "routeKeys": {}, "namedRegex": "^/now(?:/)?$" }, { "page": "/personal-blog-mcp-server", "regex": "^/personal\\-blog\\-mcp\\-server(?:/)?$", "routeKeys": {}, "namedRegex": "^/personal\\-blog\\-mcp\\-server(?:/)?$" }, { "page": "/profile", "regex": "^/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/profile(?:/)?$" }, { "page": "/profile/settings", "regex": "^/profile/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/profile/settings(?:/)?$" }, { "page": "/studio", "regex": "^/studio(?:/)?$", "routeKeys": {}, "namedRegex": "^/studio(?:/)?$" }], "dynamic": [{ "page": "/admin/garden/[id]/edit", "regex": "^/admin/garden/([^/]+?)/edit(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/admin/garden/(?<nxtPid>[^/]+?)/edit(?:/)?$" }, { "page": "/admin/posts/[id]/edit", "regex": "^/admin/posts/([^/]+?)/edit(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/admin/posts/(?<nxtPid>[^/]+?)/edit(?:/)?$" }, { "page": "/admin/projects/[id]/edit", "regex": "^/admin/projects/([^/]+?)/edit(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/admin/projects/(?<nxtPid>[^/]+?)/edit(?:/)?$" }, { "page": "/api/ai/artifact/[id]", "regex": "^/api/ai/artifact/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/ai/artifact/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/garden/[slug]", "regex": "^/api/garden/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/garden/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/posts/[id]/react", "regex": "^/api/posts/([^/]+?)/react(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/posts/(?<nxtPid>[^/]+?)/react(?:/)?$" }, { "page": "/api/projects/[slug]", "regex": "^/api/projects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/projects/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/auth/reset-password/[token]", "regex": "^/auth/reset\\-password/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/auth/reset\\-password/(?<nxtPtoken>[^/]+?)(?:/)?$" }, { "page": "/blog/[slug]", "regex": "^/blog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/blog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/cog/[slug]", "regex": "^/cog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/cog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/forge/[slug]", "regex": "^/forge/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/forge/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/garden/[slug]", "regex": "^/garden/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/garden/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [{ "source": "/(.*)", "headers": [{ "key": "Content-Security-Policy", "value": "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' blob: data:; style-src 'self' 'unsafe-inline' blob: data:; img-src 'self' data: blob: https:; font-src 'self' data: blob:; connect-src 'self' https: http: ws: wss: blob: data:; media-src 'self' blob: https: data:; worker-src 'self' blob: data:; frame-src 'none'; form-action 'self'; base-uri 'self'; manifest-src 'self'; object-src 'none'" }], "regex": "^(?:/(.*))(?:/)?$" }];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/dashboard", "dataRoute": "/admin/dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/garden": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/garden", "dataRoute": "/admin/garden.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/garden/new": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/garden/new", "dataRoute": "/admin/garden/new.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/hub": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/hub", "dataRoute": "/admin/hub.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/posts": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/posts", "dataRoute": "/admin/posts.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/posts/new": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/posts/new", "dataRoute": "/admin/posts/new.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/projects": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/projects", "dataRoute": "/admin/projects.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/projects/new": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/projects/new", "dataRoute": "/admin/projects/new.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/settings", "dataRoute": "/admin/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/forgot-password": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/forgot-password", "dataRoute": "/auth/forgot-password.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/login", "dataRoute": "/auth/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/signup": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/signup", "dataRoute": "/auth/signup.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/blog": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/blog", "dataRoute": "/blog.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/forge": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/forge", "dataRoute": "/forge.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/garden": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/garden", "dataRoute": "/garden.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/hub": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/hub", "dataRoute": "/hub.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/now": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/now", "dataRoute": "/now.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/profile": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/profile", "dataRoute": "/profile.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/profile/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/profile/settings", "dataRoute": "/profile/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/studio": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/studio", "dataRoute": "/studio.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "cc29ff1e2a398430fa870e20e66e5948", "previewModeSigningKey": "23275e43f95869d75cdeb646331ba42e84957d3ec33f6d4ac92982a3914ae407", "previewModeEncryptionKey": "c57efd9061ebd059603a84ced532198afd72268944ed7b43b83911877f748712" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0a9gg_0.js", "server/edge/chunks/[root-of-the-server]__0_lzsr-._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_09_s2fq.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_09_s2fq.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/auth/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/api/auth/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "KPt2C626p4VEDV0-kLZ21", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "9ktXrJ8on7VWC7c5po0d2KSLh7XtJXnInLgF188ZurE=", "__NEXT_PREVIEW_MODE_ID": "cc29ff1e2a398430fa870e20e66e5948", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c57efd9061ebd059603a84ced532198afd72268944ed7b43b83911877f748712", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "23275e43f95869d75cdeb646331ba42e84957d3ec33f6d4ac92982a3914ae407" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/admin/dashboard/page": "/admin/dashboard", "/admin/garden/[id]/edit/page": "/admin/garden/[id]/edit", "/admin/garden/new/page": "/admin/garden/new", "/admin/garden/page": "/admin/garden", "/admin/hub/page": "/admin/hub", "/admin/posts/[id]/edit/page": "/admin/posts/[id]/edit", "/admin/posts/new/page": "/admin/posts/new", "/admin/posts/page": "/admin/posts", "/admin/projects/[id]/edit/page": "/admin/projects/[id]/edit", "/admin/projects/new/page": "/admin/projects/new", "/admin/projects/page": "/admin/projects", "/admin/settings/page": "/admin/settings", "/api/admin/garden/route": "/api/admin/garden", "/api/admin/hub/route": "/api/admin/hub", "/api/admin/posts/route": "/api/admin/posts", "/api/admin/projects/route": "/api/admin/projects", "/api/admin/settings/route": "/api/admin/settings", "/api/ai/artifact/[id]/route": "/api/ai/artifact/[id]", "/api/ai/chunk/route": "/api/ai/chunk", "/api/ai/image/route": "/api/ai/image", "/api/ai/mnemonic/route": "/api/ai/mnemonic", "/api/ai/recall-questions/route": "/api/ai/recall-questions", "/api/ai/search/route": "/api/ai/search", "/api/ai/text/route": "/api/ai/text", "/api/ai/verify/route": "/api/ai/verify", "/api/ai/video/route": "/api/ai/video", "/api/ai/web-read/route": "/api/ai/web-read", "/api/auth/check/route": "/api/auth/check", "/api/auth/forgot-password/route": "/api/auth/forgot-password", "/api/auth/google/callback/route": "/api/auth/google/callback", "/api/auth/google/route": "/api/auth/google", "/api/auth/login/route": "/api/auth/login", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/register/route": "/api/auth/register", "/api/auth/reset-password/route": "/api/auth/reset-password", "/api/comments/route": "/api/comments", "/api/garden/[slug]/route": "/api/garden/[slug]", "/api/garden/route": "/api/garden", "/api/guestbook/route": "/api/guestbook", "/api/hub/route": "/api/hub", "/api/posts/[id]/react/route": "/api/posts/[id]/react", "/api/posts/route": "/api/posts", "/api/projects/[slug]/route": "/api/projects/[slug]", "/api/projects/route": "/api/projects", "/api/reactions/route": "/api/reactions", "/api/route": "/api", "/api/search/route": "/api/search", "/api/subscriptions/route": "/api/subscriptions", "/api/summarize/route": "/api/summarize", "/api/system/stats/route": "/api/system/stats", "/api/system/status/route": "/api/system/status", "/api/upload/route": "/api/upload", "/api/user/activity/route": "/api/user/activity", "/api/user/ai-history/route": "/api/user/ai-history", "/api/user/badges/route": "/api/user/badges", "/api/user/bookmark/route": "/api/user/bookmark", "/api/user/profile/route": "/api/user/profile", "/api/user/security/password/route": "/api/user/security/password", "/api/user/settings/notifications/route": "/api/user/settings/notifications", "/api/user/settings/privacy/route": "/api/user/settings/privacy", "/api/user/stats/route": "/api/user/stats", "/auth/forgot-password/page": "/auth/forgot-password", "/auth/login/page": "/auth/login", "/auth/reset-password/[token]/page": "/auth/reset-password/[token]", "/auth/signup/page": "/auth/signup", "/blog/[slug]/page": "/blog/[slug]", "/blog/page": "/blog", "/cog/[slug]/page": "/cog/[slug]", "/forge/[slug]/page": "/forge/[slug]", "/forge/page": "/forge", "/garden/[slug]/page": "/garden/[slug]", "/garden/page": "/garden", "/hub/page": "/hub", "/now/page": "/now", "/page": "/", "/personal-blog-mcp-server/route": "/personal-blog-mcp-server", "/profile/page": "/profile", "/profile/settings/page": "/profile/settings", "/studio/page": "/studio" };
