        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-sm font-black uppercase tracking-widest hidden sm:block">Forge <span className="text-primary">New Content</span></h2>
            </div>
                  ...
                  <CardContent className="p-8 space-y-8">
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted/30 rounded-2xl border-2 border-dashed border-muted">
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-muted-foreground font-medium italic">Make public immediately</p>
                      </div>
                      <input
                        type="checkbox"
                        id="published"
                    ...
                    <div className="pt-4 border-t-2 border-dashed border-muted">
                      <div className="flex items-center gap-3 text-primary mb-4">
                        ...
                        <span className="text-xs font-black uppercase tracking-tight">System Ready</span>
                      </div>
